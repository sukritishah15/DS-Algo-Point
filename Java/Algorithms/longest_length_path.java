package Algorithms;/*Java program to find the longest length path in a matrix*/
	...
	{ 
		...
		for (int i = 0; i < n; i++) { 
			for (int j = 0; j < n; j++) { 
				...
				//Result needs to be updated when we get a better Algorithms.solution
...
~/2020-10-01-024519$ javac Algorithms.longest_length_path.java
Picked up _JAVA_OPTIONS: -Djava.io.tmpdir=/home/user/tmp/ -Xms64m
~/2020-10-01-024519$ java Algorithms.longest_length_path
Picked up _JAVA_OPTIONS: -Djava.io.tmpdir=/home/user/tmp/ -Xms64m
...
Time complexity for the above Algorithms.solution is O(n^2).
