...
class DListNode{
    ...
    public int item;
    public DataStructures.DListNode prev;
    public DataStructures.DListNode next;
...
public class DList {
    ...
    protected DataStructures.DListNode head;
    protected DataStructures.DListNode tail;
    protected long size;
    ...
    public DList(int a) {
        head = new DataStructures.DListNode();
        tail = head;
        head.item = a;
        size = 1;
    }
    ...
    public DList(int a, int b) {
        head = new DataStructures.DListNode();
        head.item = a;
        tail = new DataStructures.DListNode();
        tail.item = b;
        head.next = tail;
        tail.prev = head;
        size = 2;
    ...
    public void insertFront(int i) {
        DataStructures.DListNode node = new DataStructures.DListNode(i);
        if(size == 0){
            head = tail = node;
        }else {
            node.next = head;
    ...
    public String toString() {
        String result = "[  ";
        DataStructures.DListNode current = head;
        while (current != null) {
 ...
 *
 * Input:-
 * DataStructures.DList lst1 = new DataStructures.DList();
 * lst1.insertFront(5);
 * lst1.insertFront(4);
 * lst1.insertFront(3);
 *
