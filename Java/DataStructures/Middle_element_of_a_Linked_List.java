...
we can implement the Algorithms.solution in one traversal,
...
public class Middle_element_of_a_Linked_List { 
	...
	// Method to print the middle element of the DataStructures.LinkedList.
	public static void printMiddleElement(LinkedList list) 
	{ 
		Node slow_pointer = list.head;
        Node fast_pointer = list.head; 

		System.out.print("Middle element of the DataStructures.LinkedList is: ");

		// Traverse through the DataStructures.LinkedList incrementing both pointers until the fast one
        // reaches the end
	...
	{ 
		...
		// Print the middle element of first DataStructures.LinkedList
        ...
        // Print the middle element of second DataStructures.LinkedList
...
Output:
Middle element of the DataStructures.LinkedList is: 3
Middle element of the DataStructures.LinkedList is: 4
