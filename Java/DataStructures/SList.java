...
class SListNode {
    int item;
    DataStructures.SListNode next;

    SListNode(int obj, DataStructures.SListNode next) {
        item = obj;
        this.next = next;
    }
...
public class SList {
    ...
    private DataStructures.SListNode head;
    private DataStructures.SListNode tail;
    private int size;
    ...
    public void insertFront(int obj) {
        head = new DataStructures.SListNode(obj, head);
        if(size == 0){
            tail = head;
        }
        size++;
    ...
    public void insertEnd(int obj) {
        DataStructures.SListNode node = new DataStructures.SListNode(obj);
        if (size == 0) {
            head = tail = node;
        } else {
            tail.next = node;
    ...
    public void removeEnd(){
        if(head == null){
            ...
            DataStructures.SListNode current;
            current = head;
    ...
    public String toString() {
        ...
        DataStructures.SListNode cur = head;
 ...
 * 
 * Input:-
 * DataStructures.SList lst1 = new DataStructures.SList();
 * lst1.insertFront(5);
 * lst1.insertFront(4);
 * lst1.insertFront(3);
 *
