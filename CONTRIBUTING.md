...
- Browse code and issue list, Find some existing issue or create anew one.
- Comment on issue you want to work on. Don't forget to mention language you are planning to use.
- Wait for issue to be assigned to you
- Fork the project and create a new branch
- Add a new file in this new branch with follwing contents
...
- Create a pull request and mention the issue number
- Wait for it to get reviewed and approved
